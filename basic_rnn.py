...
while True:
    ...
    for i in range(0,(len(train_X)//batch_size)*batch_size,batch_size):
        ...
        acc,loss,_=sess.run([model.accuracy,model.cost,model.optimizer],feed_dict={model.X:batch_x,model.Y:train_onehot[i:i+batch_size]})
        train_acc+=acc
        train_loss+=loss
    ...
    print('epoch :%d,training loss:%f,training acc:%f,valid_loss:%f,valid_acc:%f'%(EPOCH,train_loss,train_acc,test_loss,test_acc))
